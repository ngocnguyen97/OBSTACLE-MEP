...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\centering \includegraphics[width=0.5\textwidth]{epsfile1/Lambda}
	% figure caption is below the figure
...
\begin{algorithm}[H]
	...
	{$ child1[i] = indi2[i] $\;
	$ i++ $}
	Randomly generate $ λ $ that $ -1 < \gamma < 2 $\;	
	\For{$ i= 0 ... n-1 $}
		{$ child2[i+1] =\gamma * child1[i] + (1- λ) indi2[i+1] $\;
...
\begin{figure*}[h] 
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.35\linewidth]{epsfile1/cambien1} &\includegraphics[width=0.6\linewidth]{epsfile1/cambien3}\\
		(a)&(b)
	\end{tabular}
	% figure caption is below the figure
...
\begin{figure*}[h] 
	\centering
	\begin{tabular}{cc}
	\includegraphics[width=0.6\linewidth]{epsfile1/cambien2th1} &\includegraphics[width=0.5\linewidth]{epsfile1/cambien2th2} \\
...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\includegraphics[width=0.4\textwidth]{epsfile1/hoituga1}
	% figure caption is below the figure
...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\includegraphics[width=0.4\textwidth]{epsfile1/dlc-ga}
	% figure caption is below the figure
...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\includegraphics[width=0.4\textwidth]{epsfile1/hoitupso}
	% figure caption is below the figure
...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\includegraphics[width=0.4\textwidth]{epsfile1/dlc-pso}
	% figure caption is below the figure
...
\begin{figure*}[h]
	% Use the relevant command to insert your figure file.
	% For example, with the graphicx package use
	\includegraphics[width=0.4\textwidth]{epsfile1/dlc-all-sensor}
	% figure caption is below the figure
